  ...
  <div class="">
    <header class="bg-blue-500 p-4 w-full z-50 flex justify-between px-12">
      ...
      <div class="flex gap-3">
        ...
        <button @click="loguot" class="font-bold text-white">Đăng Xuất</button>
      </div>
    </header>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    logout() {
      this.jwtToken = null; // Đặt giá trị jwtToken là null
      document.cookie =
        "jwtToken=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;"; // Xóa cookie chứa token
    },
  },
};
</script>
