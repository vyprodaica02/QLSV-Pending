...
export default {
  ...
  data() {
    return {
      myCookieValue: null, // Khởi tạo giá trị ban đầu của cookie là null
    };
  },
  mounted() {
    this.myCookieValue = this.getCookieValue("myCookieName"); // Gọi hàm để lấy giá trị cookie khi component được mounted
  },
  methods: {
