<template>
  <div class="fixed inset-0 flex items-center justify-center">
    ...
    <div
      class="dialog bg-white p-6 rounded-lg shadow-md grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"
    >
      <form
        @submit.prevent="submitForm"
        class="bg-white p-6 rounded-lg shadow-md grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"
      >
        <div class="mb-4">
          <label for="HoSinhVien" class="block text-gray-700"
            >Họ Sinh Viên</label
          >
          <input
            v-model="HoSinhVien"
        ...
        <div class="mb-4">
          ...
          <div
            v-else-if="DienThoai !== null && isNaN(Number(DienThoai))"
            class="text-red-500"
          >
