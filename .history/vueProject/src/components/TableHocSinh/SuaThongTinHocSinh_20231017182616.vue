...
export default defineComponent({
  ...
  methods: {
    oke() {
      console.log(this.selectedItem.ngaySinh);
    },
    //    "NgaySinh",
    ...
    async submitForm() {
      ...
      if (this.formattedNgaySinh !== null) {
        formData.append("DiaChi", this.formattedNgaySinh);
      }
      if (
    ...
    formatDate() {
      ...
      this.NgaySinh = date.toLocaleDateString();
  ...
  computed: {
    formattedNgaySinh: {
      get() {
        return this.selectedItem.ngaySinh
          ? this.selectedItem.ngaySinh.split("T")[0]
          : "";
      },
      set(value) {
